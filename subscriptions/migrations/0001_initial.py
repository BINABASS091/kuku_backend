    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('farmerSubscriptionID', models.ForeignKey(blank=True, db_column='farmerSubscriptionID', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscription_resources', to='subscriptions.farmersubscription')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('subscription_resources', models.ManyToManyField(help_text='Subscriptions that use this resource', related_name='resource_allocations', through='subscriptions.FarmerSubscriptionResource', to='subscriptions.farmersubscription')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='resourceID',
            field=models.ForeignKey(blank=True, db_column='resourceID', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='allocations', to='subscriptions.resource'),
        ),
        migrations.AddIndex(
            model_name='resource',
        ...
        migrations.AddIndex(
            model_name='farmersubscriptionresource',
            index=models.Index(fields=['farmerSubscriptionID', 'resourceID'], name='farmer_subs_farmerS_c305bf_idx'),
        ),
        migrations.AddIndex(
            model_name='farmersubscriptionresource',
